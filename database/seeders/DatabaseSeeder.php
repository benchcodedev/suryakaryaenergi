    ...
    public function run(): void
    {
        ...
        User::updateOrCreate(
            ...
            [
                ...
                'password' => Hash::make('SuryaKarya2026!'),
            ]
        );

        // 2. Seed 6 Real Case-Study Projects
        $projects = [
            [
                ...
                'images' => [
                    ['image_url' => 'https://images.unsplash.com/photo-1508873696983-2df5293cb32f?auto=format&fit=crop&w=1000&q=80', 'caption' => 'Inspeksi modul solar panel pada struktur atap pabrik', 'sort_order' => 1],
                    ['image_url' => 'https://images.unsplash.com/photo-1497440001374-f26997328c1b?auto=format&fit=crop&w=1000&q=80', 'caption' => 'Ruang inverter dan panel distribusi sinkronisasi tegangan', 'sort_order' => 2],
                ],
            ],
            [
                ...
                'images' => [
                    ['image_url' => 'https://images.unsplash.com/photo-1545208942-e1c9c916524b?auto=format&fit=crop&w=1000&q=80', 'caption' => 'Bentang solar array ground-mounted dengan solar tracking system', 'sort_order' => 1],
                    ['image_url' => 'https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?auto=format&fit=crop&w=1000&q=80', 'caption' => 'Instalasi interkoneksi step-up transformer 20 kV', 'sort_order' => 2],
                ],
            ],
            [
                ...
                'status' => 'Selesai',
                'is_featured' => true,
                'cover_image' => 'https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?auto=format&fit=crop&w=1200&q=80',
                ...
                'images' => [
                    ['image_url' => 'https://images.unsplash.com/photo-1513836279014-a89f7a76ae86?auto=format&fit=crop&w=1000&q=80', 'caption' => 'Switchyard outdoor 150 kV gardu induk', 'sort_order' => 1],
                ],
            ],
            [
                ...
                'status' => 'Berjalan',
                'is_featured' => false,
                'cover_image' => 'https://images.unsplash.com/photo-1545208942-e1c9c916524b?auto=format&fit=crop&w=1200&q=80',
                ...
                'images' => [
                    ['image_url' => 'https://images.unsplash.com/photo-1509391365360-2e959784a276?auto=format&fit=crop&w=1000&q=80', 'caption' => 'Instalasi modul fotovoltaik kepulauan Morotai', 'sort_order' => 1],
                ],
            ],
            [
                ...
                'images' => [
                    ['image_url' => 'https://images.unsplash.com/photo-1497440001374-f26997328c1b?auto=format&fit=crop&w=1000&q=80', 'caption' => 'Pemeriksaan drone thermal imaging untuk deteksi hotspot sel', 'sort_order' => 1],
                ],
            ],
            [
                ...
                'status' => 'Perencanaan',
                'is_featured' => false,
                'cover_image' => 'https://images.unsplash.com/photo-1466611653911-95081537e5b7?auto=format&fit=crop&w=1200&q=80',
        ...
        foreach ($projects as $item) {
            ...
            $project = Project::updateOrCreate(['slug' => $item['slug']], $item);
        ...
        ContactMessage::updateOrCreate(
            ...
            [
                ...
                'company' => 'PT Indotech Mandiri Perkasa',
                'service' => 'Solar PV System (PLTS)',
        ...
        ContactMessage::updateOrCreate(
            ...
            [
                ...
                'company' => 'Konsorsium Surya Nusantara',
                'service' => 'EPC Gardu & Transmisi',
