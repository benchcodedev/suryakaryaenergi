                ...
                <div class="grid grid-cols-1 gap-4 flex-1 auto-rows-fr">
                    ...
                    <div class="h-full flex items-center space-x-4 p-5 rounded-2xl bg-stone-50 border border-stone-200 hover:border-brown-400 hover:shadow-sm transition-all duration-200">
                        ...
                        <div class="min-w-0 flex-1">
                            <h4 class="font-bold text-stone-900 text-sm">Kantor Jakarta</h4>
                            <p class="text-stone-600 text-xs mt-0.5 leading-relaxed">
                                Wisma 77 Tower 1 Lt. 8, Jl. Letjen S. Parman Kav. 77, Slipi, Kec. Palmerah, Kota Jakarta Barat, DKI Jakarta 11410
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="h-full flex items-center space-x-4 p-5 rounded-2xl bg-stone-50 border border-stone-200 hover:border-brown-400 hover:shadow-sm transition-all duration-200">
                        ...
                        <div class="min-w-0 flex-1">
                            <h4 class="font-bold text-stone-900 text-sm">Kantor Operasional (Jepara)</h4>
                            <p class="text-stone-600 text-xs mt-0.5 leading-relaxed">
                                Perum Pandan Sari 02 RT/RW 10/04 Kedungcino, Jepara, Kab. Jepara, Jawa Tengah 59418
                            </p>
                        </div>
                    </div>
