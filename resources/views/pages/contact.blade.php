        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div class="lg:col-span-5 space-y-8">
                ...
                <div class="space-y-4 text-sm">
                    <!-- Address -->
                    <div class="flex items-start space-x-4 p-5 rounded-2xl bg-stone-50 border border-stone-200">
                        <div class="w-10 h-10 rounded-xl bg-brown-100 text-brown-600 flex items-center justify-center shrink-0 mt-0.5">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                        </div>
                        <div>
                            <h4 class="font-bold text-stone-900">Alamat Kantor Pusat</h4>
                            <p class="text-stone-600 text-xs mt-1 leading-relaxed">
                                Menara Palma Lt. 12, Jl. H.R. Rasuna Said Blok X-2 Kav. 6, Kuningan, Setiabudi, Jakarta Selatan 12950
                            </p>
                            <p class="text-stone-500 text-[11px] mt-1 italic">Workshop: Kawasan Industri MM2100 Cikarang Barat, Bekasi</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4 p-5 rounded-2xl bg-stone-50 border border-stone-200">
                        ...
                        <div>
                            <h4 class="font-bold text-stone-900">Telepon & WhatsApp Cepat</h4>
                            <p class="text-stone-600 text-xs mt-1">Telepon Kantor: +62 21 8990 1234</p>
                            <p class="text-stone-600 text-xs">WhatsApp Hotline: +62 812-3456-7890</p>
                            <a href="https://wa.me/6281234567890?text=Halo%20PT%20Surya%20Karya%20Energi,%20saya%20tertarik%20konsultasi%20solusi%20PLTS%20industri" 
                               target="_blank" 
                               class="inline-block mt-2 text-xs font-bold text-emerald-700 hover:text-emerald-800">
                    ...
                    <div class="flex items-start space-x-4 p-5 rounded-2xl bg-stone-50 border border-stone-200">
                        ...
                        <div>
                            <h4 class="font-bold text-stone-900">Email Resmi</h4>
                            <p class="text-stone-600 text-xs mt-1">info@suryakaryaenergi.com</p>
                            <p class="text-stone-600 text-xs">proyek@suryakaryaenergi.com</p>
                        </div>
                    </div>

                    <!-- Hours -->
                    <div class="flex items-start space-x-4 p-5 rounded-2xl bg-stone-50 border border-stone-200">
                        <div class="w-10 h-10 rounded-xl bg-stone-200 text-stone-700 flex items-center justify-center shrink-0 mt-0.5">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        </div>
                        <div>
                            <h4 class="font-bold text-stone-900">Jam Kerja Operasional</h4>
                            <p class="text-stone-600 text-xs mt-1">Senin ? Jumat: 08.00 ? 17.00 WIB</p>
                            <p class="text-stone-500 text-xs">Tim O&M & Darurat: Siaga 24 Jam</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:col-span-7">
                <div class="bg-stone-50 rounded-3xl p-8 sm:p-10 border border-stone-200 shadow-sm">
